...
const SONG_SRC = "/assets/a.r._rahman_javed_ali_-_tum_tak_lyrics_256k-019d5daa-0c87-700c-89e9-5e4eb0324873.mp3";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      style: {
        ...
        background: "linear-gradient(rgba(246, 240, 230, 0.55), rgba(239, 162, 170, 0.65)), url('/assets/generated/couple-hugging.dim_1920x1080.jpg') center/cover no-repeat",
        cursor: "pointer",
        userSelect: "none",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "A special surprise awaits you, Sakshi..."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
...
function FloatingHearts() {
  const [hearts] = reactExports.useState(
...
function HeartConfetti({ onComplete }) {
  ...
  const initParticles = reactExports.useCallback(() => {
    const count = 90;
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "dialog",
          {
            ...
            style: {
              ...
              maxWidth: "420px",
              width: "100%",
              boxShadow: "0 24px 64px rgba(140, 43, 82, 0.28), 0 4px 20px rgba(192, 68, 106, 0.18)",
              ...
              gap: "20px",
              textAlign: "center",
              animation: "dialogSlideUp 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
              position: "relative",
              margin: 0
            },
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Great choice ! Now, wait I have something for you !!"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
...
function App() {
  ...
  const [hasClickedYes, setHasClickedYes] = reactExports.useState(false);
  const [showYesDialog, setShowYesDialog] = reactExports.useState(false);
  const [showConfetti, setShowConfetti] = reactExports.useState(false);
  const [noClickCount, setNoClickCount] = reactExports.useState(0);
  const [noButtonPos, setNoButtonPos] = reactExports.useState(null);
  const { startMusic } = useBgMusic();
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  const handleSplashStart = reactExports.useCallback(() => {
    startMusic();
    setSplashDone(true);
  }, [startMusic]);
  ...
  const handleDialogDismiss = reactExports.useCallback(() => {
  ...
  const noLabel = noClickCount === 0 ? "No 🙅" : NO_PHRASES[(noClickCount - 1) % NO_PHRASES.length];
  const pageBg = {
    background: "linear-gradient(rgba(246, 240, 230, 0.55), rgba(239, 162, 170, 0.65)), url('/assets/generated/couple-hugging.dim_1920x1080.jpg') center/cover no-repeat fixed",
    minHeight: "100vh",
    position: "relative",
    overflow: "hidden"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: pageBg, children: [
    !splashDone && /* @__PURE__ */ jsxRuntimeExports.jsx(SplashScreen, { onStart: handleSplashStart }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHearts, {}),
    showYesDialog && /* @__PURE__ */ jsxRuntimeExports.jsx(YesDialog, { onDismiss: handleDialogDismiss }),
    showConfetti && /* @__PURE__ */ jsxRuntimeExports.jsx(HeartConfetti, { onComplete: handleConfettiComplete }),
    !hasClickedYes ? (
      // ===== MAIN SCREEN =====
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "main",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 8px 40px rgba(140, 43, 82, 0.18), 0 2px 12px rgba(192, 68, 106, 0.12)",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    ...
                    children: "Happy Birthday in advance, Sakshi ! They say birthdays are for making wishes, but I'm hoping you'll grant mine: Will you celebrate your special day with me this time?🎂💌🕊️?"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      noButtonPos === null ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                ...
                backdropFilter: "blur(20px)",
                WebkitBackdropFilter: "blur(20px)",
                boxShadow: "0 8px 40px rgba(140, 43, 82, 0.22), 0 2px 12px rgba(192, 68, 106, 0.15)",
                border: "1px solid rgba(181, 106, 122, 0.3)",
                position: "relative",
                zIndex: 10
              },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "You've made me the happiest! 🌟"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "This Birthday is going to be magical with you by my side...!!"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Can't wait to celebrate with you, Sakshi !!! 🎂🌹"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    !hasClickedYes && noButtonPos !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: handleNoClick,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "footer",
      {
        ...
        children: [
          ...
          ". Built with",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": "true", style: { color: "#C0446A" }, children: "❤️" }),
          " ",
          "using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
